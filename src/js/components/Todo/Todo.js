    ...
    <>
      ...
      <main className = "task__main">
        <section onClick = {switchTodo} className = {todoSwitcher ? "task__wrapper task__wrapper_backgroundColor_white" : "task__wrapper"}>
          ...
          <div contentEditable = "true" placeholder = "Write a task here" onInput = {() => inputHandler("task__input")} id = "task__input" className = {todoSwitcher ? "task__input" : "task__input task__input_color_golden task__input_display_none"} placeholder = "Write a new task"></div>
        </section>
      </main>
